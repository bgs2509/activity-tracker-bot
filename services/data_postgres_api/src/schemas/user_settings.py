...
class UserSettingsBase(BaseModel):
    ...
    poll_interval_weekday: int = Field(default=120, ge=1, le=360, description="Poll interval for weekdays in minutes")
    poll_interval_weekend: int = Field(default=180, ge=1, le=480, description="Poll interval for weekends in minutes")
...
class UserSettingsUpdate(BaseModel):
    ...
    poll_interval_weekday: int | None = Field(None, ge=1, le=360)
    poll_interval_weekend: int | None = Field(None, ge=1, le=480)
